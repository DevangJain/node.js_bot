...
mongo.connect('mongodb+srv://dj10000000000000:gFfryRyAa0FvOeEi@cluster0.3c0tbz6.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0', { useUnifiedTopology: true }, (err, client) => {
    if (err) {
        console.log(err);
    }
    db = client.db('Demot1');
